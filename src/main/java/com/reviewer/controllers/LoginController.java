...
public class LoginController {
	...
	public ResponseEntity<String> login(HttpSession httpsession, @RequestParam String email, @RequestParam String password) {
		...
		try {
			...
			e.printStackTrace();
			return ResponseEntity.internalServerError().body("Unexpected Error occured during Login");
		}
